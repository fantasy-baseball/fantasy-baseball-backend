...
const saveGameResults = async (gameDate) => {
  try {
    ...
    const gameResults = await crawlGameResult(gameIds);
    ...
    console.log(hitterStatistics.length + pitcherStatistics.length);
  } catch (err) {
    console.error(err);
  }
};
...
/*
const saveGameResult = require("./testFunction/saveGameResult");
